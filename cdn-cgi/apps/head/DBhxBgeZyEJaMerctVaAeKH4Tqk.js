;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="95fe32e018c406b8bd4a76deb4dd4869";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["ye5PJbktBvBy"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["ye5PJbktBvBy"].options={"anonymizeIp":false,"id":"UA-139205564-1","social":false};;if(CloudflareApps.matchPage(CloudflareApps.installs['ye5PJbktBvBy'].URLPatterns)){(function(){var options=CloudflareApps.installs['ye5PJbktBvBy'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("ye5PJbktBvBy"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
